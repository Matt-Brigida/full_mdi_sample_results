...
## RCFD2150 /* OREO                            */
  ...
  ## RCON1400 /* TOTAL LOANS GROSS               */
  ## RCON2122 /* TOTAL LOANS NET                 */
  ## RCFD3210 /* TOTAL EQUITY                    */
  ## RCFD3123 /* ALLOWANCE FOR LOAN LOSSES       */
  ## RIAD4340 /* NET INCOME YTD                  */


## loans 30-89 days PD / total assets
fe3 <- plm(I(RCFD1406 / RCFD2170) ~  SBLTOT_TA + I(mdi_ind*EQTA0) + EQTA0 + ROA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all, model = "within", effect = "twoways")
                                                                                 
fe4 <- plm(I(RCFD1407 / RCFD2170) ~  SBLTOT_TA + I(mdi_ind*EQTA0) + EQTA0 + ROA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all, model = "within", effect = "twoways")
                                                                                 
fe5 <- plm(I(RCFD3123 / RCFD2170) ~  SBLTOT_TA + I(mdi_ind*EQTA0) + EQTA0 + ROA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all, model = "within", effect = "twoways")

## RCFD1403 /* NONACCRUAL LOANS                */
fe6 <- plm(I(RCFD1403 / RCFD2170) ~  SBLTOT_TA + I(mdi_ind*EQTA0) + EQTA0 + ROA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all, model = "within", effect = "twoways")

## RCFD2150 /* OREO                            */
fe7 <- plm(I(RCFD2150 / RCFD2170) ~  SBLTOT_TA + I(mdi_ind*EQTA0) + EQTA0 + ROA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all, model = "within", effect = "twoways")
...
fe4 <- plm(I(RCFD1407 / RCFD2170) ~  SBLTOT_TA + BIGBANK + BIGBKFC + BIGBKPC + mdi_ind*EQTA0 + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all, model = "within", effect = "twoways")
