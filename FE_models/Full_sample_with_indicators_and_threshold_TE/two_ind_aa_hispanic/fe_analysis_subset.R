...
fe3 <- plm(CSBLTOT ~  black_ind*EQTA0 + hispanic_ind*EQTA0  + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all_greater_thresh, model = "within", effect = "twoways")

## Table 4

fe4 <- plm(CSBLTOT ~  BIGBANK + BIGBKFC + BIGBKPC + black_ind*EQTA0 + hispanic_ind*EQTA0 +  SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all_greater_thresh, model = "within", effect = "twoways")


## Table 5

fe5 <- plm(CSBLTOT ~  BADBANK + BADBKFC + BADBKPC + black_ind*EQTA0 + hispanic_ind*EQTA0 + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all_greater_thresh, model = "within", effect = "twoways")
...
fe6 <- plm(CNUMSBL ~  black_ind*EQTA0 + hispanic_ind*EQTA0 + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all_greater_thresh, model = "within", effect = "twoways")

## Table 7

fe7 <- plm(CNUMSBL ~  BIGBANK + BIGBKFC + BIGBKPC + black_ind*EQTA0 + hispanic_ind*EQTA0 + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all_greater_thresh, model = "within", effect = "twoways")

## Table 8

fe8 <- plm(CNUMSBL ~  BADBANK + BADBKFC + BADBKPC + black_ind*EQTA0 + hispanic_ind*EQTA0 + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO, data = call_all_greater_thresh, model = "within", effect = "twoways")
...
fe.size1 <- plm(CSBLTOT ~  SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO + black_ind*EQTA0 + hispanic_ind*EQTA0 + EQTA0*LNTA0, data = call_all_greater_thresh, model = "within", effect = "twoways")


fe.size2 <- plm(CSBLTOT ~  BIGBANK + BIGBKFC + BIGBKPC + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO + black_ind*EQTA0 + hispanic_ind*EQTA0 + EQTA0*LNTA0, data = call_all_greater_thresh, model = "within", effect = "twoways")

## Table size 3

fe.size3 <- plm(CSBLTOT ~  BADBANK + BADBKFC + BADBKPC + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO + black_ind*EQTA0 + hispanic_ind*EQTA0 + EQTA0*LNTA0, data = call_all_greater_thresh, model = "within", effect = "twoways")
...
fe.size4 <- plm(CNUMSBL ~  SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO + black_ind*EQTA0 + hispanic_ind*EQTA0 + EQTA0*LNTA0, data = call_all_greater_thresh, model = "within", effect = "twoways")


fe.size5 <- plm(CNUMSBL ~  BIGBANK + BIGBKFC + BIGBKPC + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO + black_ind*EQTA0 + hispanic_ind*EQTA0 + EQTA0*LNTA0, data = call_all_greater_thresh, model = "within", effect = "twoways")

## Table size 3

fe.size6 <- plm(CNUMSBL ~  BADBANK + BADBKFC + BADBKPC + SBLTOT_TA + EQTA0 + ROA0 + NPA0 + LIQTA0 + CORETA0 + BCOMMITTAC0 + DENOVO + black_ind*EQTA0 + hispanic_ind*EQTA0 + EQTA0*LNTA0, data = call_all_greater_thresh, model = "within", effect = "twoways")
